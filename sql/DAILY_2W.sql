SELECT CONVERT(CHAR(20), AA.DATE_ID, 'dd/MM/yyyy'), AA.CELL_NAME, AA.BSC,
...
FROM "dc"."DC_E_BSS_CELL_CS_DAY"
GROUP BY DATE_ID, CELL_NAME, BSC) AA
...
FROM "dc"."DC_E_BSS_CELL_PS_DAY"
GROUP BY DATE_ID, CELL_NAME,BSC) AB
...
FROM "dc"."DC_E_BSS_CELL_ADJ_DAY"
GROUP BY DATE_ID, CELL_NAME,BSC) AC
...
FROM "dc"."DC_E_BSS_CELL3_DAY"
GROUP BY DATE_ID, CELL_NAME, BSC) AD
...
FROM "dc"."DC_E_BSS_CELL_UTRAN_ADJ_DAY"
GROUP BY DATE_ID, CELL_NAME, BSC) AF
